...
// Add ZodType-specific type helper
...
export function useFormValidation<T extends FieldValues>(
  ...
  // Fix recursive function call by renaming the function parameter
  const validateFieldAsyncFn = async (
    ...
    const syncResult = validateFieldFn(fieldName, value);
    ...
    if (asyncValidator) {
      ...
      if (typeof asyncResult === 'string') {
        ...
        return new ValidationError('Validation failed', fieldName);
      }
    }
